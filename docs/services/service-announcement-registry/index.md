...
- 분석 기준 repo: `/Users/jiin/Documents/Files/02_EVnSolution/00_Source_code/CLEVER/clever-msa-platform/development/service-announcement-registry`
- 확인 기준 브랜치: `main`
- 확인한 최근 커밋: `2ebb3246313c325b2682155668c9f46d449a8f3d 2026-04-09 feat: enforce navigation policy in announcement APIs`
...
- 핵심 앱 코드는 `announcements/` 아래에 있고 모델, API, 테스트를 함께 둔다.
...
- `announcements/`: 서비스 핵심 앱 디렉터리
- `announcements/urls.py`: 내부 API route 정의
- `announcements/tests/`: 서비스 테스트
...
- ECR repository: `service-announcement-registry`
