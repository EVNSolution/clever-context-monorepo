...
모바일 앱 표시명, repository/service id, native bundle/package id, URL scheme
구분은 [`mobile-app-identities.md`](./mobile-app-identities.md)를 따른다.

## Product service pointers

| service_id | owner_repo | context pointer | current authority | template lineage |
| --- | --- | --- | --- | --- |
| `clever-routes-app` | <https://github.com/EVNSolution/clever-routes-app> | <https://github.com/EVNSolution/clever-context-monorepo/blob/main/docs/services/clever-routes-app/index.md> | <https://github.com/EVNSolution/clever-routes-app/tree/dev> | Expo / React Native native iOS and Android app bootstrap |
...
| `clever-delivery-server` | <https://github.com/EVNSolution/clever-route-server> | <https://github.com/EVNSolution/clever-context-monorepo/blob/main/docs/services/clever-delivery-server/index.md> | <https://github.com/EVNSolution/clever-route-server/tree/main/apps/delivery-api> | Fastify / Prisma delivery API runtime paired with Shopify admin and CLEVER Routes |
