...
- 분석 기준 repo: `/Users/jiin/Documents/Files/02_EVnSolution/00_Source_code/CLEVER/clever-msa-platform/development/service-region-analytics`
- 확인 기준 브랜치: `main`
- 확인한 최근 커밋: `606972edfe4ffd9269dd8cee81298ae6042311dd 2026-04-09 feat: enforce navigation policy in region analytics APIs`
...
- 핵심 앱 코드는 `regionanalytics/` 아래에 있고 모델, API, 테스트를 함께 둔다.
...
- `regionanalytics/`: 서비스 핵심 앱 디렉터리
- `regionanalytics/urls.py`: 내부 API route 정의
- `regionanalytics/tests/`: 서비스 테스트
...
- management command: `seed_region_analytics`
...
- ECR repository: `service-region-analytics`
