...
- 분석 기준 repo: `/Users/jiin/Documents/Files/02_EVnSolution/00_Source_code/CLEVER/clever-msa-platform/development/service-terminal-registry`
- 확인 기준 브랜치: `main`
- 확인한 최근 커밋: `2bdd9c0389e1e949e6c6c243184ba99c91a93209 2026-04-09 feat: enforce navigation policy in terminal APIs`
...
- 핵심 앱 코드는 `terminals/` 아래에 있고 모델, API, 테스트를 함께 둔다.
- `terminals/services/`가 도메인 조합과 외부 연동 helper를 담당한다.
...
- `terminals/`: 서비스 핵심 앱 디렉터리
- `terminals/urls.py`: 내부 API route 정의
- `terminals/services/`: 도메인 조합 및 외부 연동 helper
- `terminals/tests/`: 서비스 테스트
...
### Worker / batch
- management command: `seed_terminals`
...
- ECR repository: `service-terminal-registry`
