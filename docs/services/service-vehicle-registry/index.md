...
- 분석 기준 repo: `/Users/jiin/Documents/Files/02_EVnSolution/00_Source_code/CLEVER/clever-msa-platform/development/service-vehicle-registry`
- 확인 기준 브랜치: `main`
- 확인한 최근 커밋: `7750d2b10c99655053a3d9b33133b32019302dff 2026-04-08 feat: enforce navigation policy in vehicle APIs`
...
- 핵심 앱 코드는 `vehicles/` 아래에 있고 모델, API, 테스트를 함께 둔다.
...
- `vehicles/`: 서비스 핵심 앱 디렉터리
- `vehicles/urls.py`: 내부 API route 정의
- `vehicles/tests/`: 서비스 테스트
...
- ECR repository: `service-vehicle-registry`
