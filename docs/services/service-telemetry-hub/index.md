...
- 분석 기준 repo: `/Users/jiin/Documents/Files/02_EVnSolution/00_Source_code/CLEVER/clever-msa-platform/development/service-telemetry-hub`
- 확인 기준 브랜치: `main`
- 확인한 최근 커밋: `8871de397545c53bf757afc2a49e099f7a9eecd0 2026-04-08 feat: add image build pipeline for telemetry hub`
...
- 핵심 앱 코드는 `telemetry/` 아래에 있고 모델, API, 테스트를 함께 둔다.
- `telemetry/services/`가 도메인 조합과 외부 연동 helper를 담당한다.
...
- `telemetry/`: 서비스 핵심 앱 디렉터리
- `telemetry/urls.py`: 내부 API route 정의
- `telemetry/services/`: 도메인 조합 및 외부 연동 helper
- `telemetry/tests/`: 서비스 테스트
...
### Worker / batch
- management command: `seed_telemetry`
...
- ECR repository: `service-telemetry-hub`
