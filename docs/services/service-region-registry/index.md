...
- 분석 기준 repo: `/Users/jiin/Documents/Files/02_EVnSolution/00_Source_code/CLEVER/clever-msa-platform/development/service-region-registry`
- 확인 기준 브랜치: `main`
- 확인한 최근 커밋: `571c7aa730743763316e273d34348caa1206206b 2026-04-08 feat: enforce navigation policy in region APIs`
...
- 핵심 앱 코드는 `regions/` 아래에 있고 모델, API, 테스트를 함께 둔다.
...
- `regions/`: 서비스 핵심 앱 디렉터리
- `regions/urls.py`: 내부 API route 정의
- `regions/tests/`: 서비스 테스트
...
- ECR repository: `service-region-registry`
