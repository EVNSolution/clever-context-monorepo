...
- 분석 기준 repo: `/Users/jiin/Documents/Files/02_EVnSolution/00_Source_code/CLEVER/clever-msa-platform/development/service-settlement-payroll`
- 확인 기준 브랜치: `main`
- 확인한 최근 커밋: `fa587c7aceb183985df54522445e104f4811eed0 2026-04-10 test: cover missing pricing table settlement failure`
...
- management command: `seed_settlements`

### 외부 연동
- 외부/연동 설정: `DELIVERY_RECORD_BASE_URL`
- 외부/연동 설정: `DISPATCH_REGISTRY_BASE_URL`
- 외부/연동 설정: `SETTLEMENT_DRIVER_BASE_URL`
- 외부/연동 설정: `SETTLEMENT_ORG_BASE_URL`
- 외부/연동 설정: `SETTLEMENT_REGISTRY_BASE_URL`
...
- ECR repository: `service-settlement-payroll`
