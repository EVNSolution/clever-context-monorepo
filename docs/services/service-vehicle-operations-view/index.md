...
- 분석 기준 repo: `/Users/jiin/Documents/Files/02_EVnSolution/00_Source_code/CLEVER/clever-msa-platform/development/service-vehicle-operations-view`
- 확인 기준 브랜치: `main`
- 확인한 최근 커밋: `985506208ce9883ef186f7f7ca19da650878190d 2026-04-09 feat: enforce navigation policy in vehicle ops APIs`
...
- 핵심 앱 코드는 `vehicleops/` 아래에 있고 모델, API, 테스트를 함께 둔다.
- `vehicleops/services/`가 도메인 조합과 외부 연동 helper를 담당한다.
...
- `vehicleops/`: 서비스 핵심 앱 디렉터리
- `vehicleops/urls.py`: 내부 API route 정의
- `vehicleops/services/`: 도메인 조합 및 외부 연동 helper
- `vehicleops/tests/`: 서비스 테스트
...
- 외부/연동 설정: `TERMINAL_REGISTRY_BASE_URL`
...
- ECR repository: `service-vehicle-operations-view`
