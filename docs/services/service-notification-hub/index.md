...
- 분석 기준 repo: `/Users/jiin/Documents/Files/02_EVnSolution/00_Source_code/CLEVER/clever-msa-platform/development/service-notification-hub`
- 확인 기준 브랜치: `main`
- 확인한 최근 커밋: `f870689b318b30dccc3467d5aee44a082903e7a9 2026-04-09 feat: enforce navigation policy in notification APIs`
...
- 핵심 앱 코드는 `notifications/` 아래에 있고 모델, API, 테스트를 함께 둔다.
...
- `notifications/`: 서비스 핵심 앱 디렉터리
- `notifications/urls.py`: 내부 API route 정의
- `notifications/tests/`: 서비스 테스트
...
- `health/`
- `fcm/tokens/`
- `fcm/tokens/<uuid:push_token_id>/`
- `general/`
- `general/<uuid:notification_id>/`
- `push-sends/`
- `push-logs/`

### Worker / batch
- management command: `seed_notifications`
...
- ECR repository: `service-notification-hub`
