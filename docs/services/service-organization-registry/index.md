...
- 분석 기준 repo: `/Users/jiin/Documents/Files/02_EVnSolution/00_Source_code/CLEVER/clever-msa-platform/development/service-organization-registry`
- 확인 기준 브랜치: `main`
- 확인한 최근 커밋: `d0500d38453d914318ef4defed76af690d748e9f 2026-04-08 feat: enforce navigation policy in organization APIs`
...
- 핵심 앱 코드는 `organizations/` 아래에 있고 모델, API, 테스트를 함께 둔다.
...
- `organizations/`: 서비스 핵심 앱 디렉터리
- `organizations/urls.py`: 내부 API route 정의
- `organizations/tests/`: 서비스 테스트
...
- management command: `seed_organization`
...
- ECR repository: `service-organization-registry`
