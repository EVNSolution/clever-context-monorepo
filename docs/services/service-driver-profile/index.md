...
- 분석 기준 repo: `/Users/jiin/Documents/Files/02_EVnSolution/00_Source_code/CLEVER/clever-msa-platform/development/service-driver-profile`
- 확인 기준 브랜치: `main`
- 확인한 최근 커밋: `e765a5dc3ffd610d9071710652a65d6d1a4fde12 2026-04-12 feat: add paged driver list responses`
...
- 핵심 앱 코드는 `drivers/` 아래에 있고 모델, API, 테스트를 함께 둔다.
...
- `drivers/`: 서비스 핵심 앱 디렉터리
- `drivers/urls.py`: 내부 API route 정의
- `drivers/tests/`: 서비스 테스트
...
- management command: `normalize_driver_names_from_external_users`
- management command: `seed_drivers`
...
- ECR repository: `service-driver-profile`
